export const PERMISSIONS = {
  ...
  ADMISSIONS_INTERVIEW: "admissions:interviews:manage",
  ADMISSIONS_VERIFY_PLACEMENT: "admissions:placement:verify",
  ADMISSIONS_OVERRIDE: "admissions:decisions:override",
  ADMISSIONS_ENROLL: "admissions:enrollment:finalize",
...
export const DEFAULT_ROLE_PERMISSIONS: Record<string, Permission[]> = {
  ...
  headmaster: [
    ...
    PERMISSIONS.ADMISSIONS_INTERVIEW,
    PERMISSIONS.ADMISSIONS_VERIFY_PLACEMENT,
    PERMISSIONS.ADMISSIONS_OVERRIDE,
    PERMISSIONS.ADMISSIONS_ENROLL,
    PERMISSIONS.STUDENTS_CREATE,
    PERMISSIONS.STUDENTS_READ,
    PERMISSIONS.STUDENTS_UPDATE,
    PERMISSIONS.STUDENTS_EXPORT,
    PERMISSIONS.STUDENTS_PROMOTE,
    PERMISSIONS.STUDENTS_ANALYTICS_READ,
  ...
  assistant_headmaster_academic: [
    ...
    PERMISSIONS.AWARDS_CREATE,
    PERMISSIONS.AWARDS_READ,
    PERMISSIONS.TRANSCRIPTS_VERIFY,
    PERMISSIONS.TRANSCRIPTS_ISSUE,
