...
export const NOTIFICATION_EVENTS = {
  ...
  ADMISSION_CONDITIONAL: "admission_conditional",
  ADMISSION_INTERVIEW_SCHEDULED: "admission_interview_scheduled",
  ADMISSION_OFFER_ISSUED: "admission_offer_issued",
  ADMISSION_OFFER_EXPIRING: "admission_offer_expiring",
  ADMISSION_OFFER_EXPIRED: "admission_offer_expired",
  ADMISSION_CONDITION_DEADLINE: "admission_condition_deadline",
  ADMISSION_APPEAL_SUBMITTED: "admission_appeal_submitted",
  ADMISSION_APPEAL_RESOLVED: "admission_appeal_resolved",
...
export const EVENT_CHANNELS: Record<NotificationEvent, ("in_app" | "sms" | "email")[]> = {
  ...
  [NOTIFICATION_EVENTS.ADMISSION_REJECTED]: ["in_app", "email"],
  [NOTIFICATION_EVENTS.ADMISSION_WAITLISTED]: ["in_app", "email"],
  [NOTIFICATION_EVENTS.ADMISSION_CONDITIONAL]: ["in_app", "sms", "email"],
  [NOTIFICATION_EVENTS.ADMISSION_INTERVIEW_SCHEDULED]: ["in_app", "sms", "email"],
  [NOTIFICATION_EVENTS.ADMISSION_OFFER_ISSUED]: ["in_app", "sms", "email"],
  [NOTIFICATION_EVENTS.ADMISSION_OFFER_EXPIRING]: ["in_app", "sms", "email"],
  [NOTIFICATION_EVENTS.ADMISSION_OFFER_EXPIRED]: ["in_app", "email"],
  [NOTIFICATION_EVENTS.ADMISSION_CONDITION_DEADLINE]: ["in_app", "sms", "email"],
  [NOTIFICATION_EVENTS.ADMISSION_APPEAL_SUBMITTED]: ["in_app", "email"],
  [NOTIFICATION_EVENTS.ADMISSION_APPEAL_RESOLVED]: ["in_app", "sms", "email"],
  [NOTIFICATION_EVENTS.ADMISSION_ENROLLED]: ["in_app", "sms", "email"],
