      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            icon: "UserSwitch",
            permission: PERMISSIONS.SUBSTITUTION_READ,
          },
          {
            title: "Teacher Availability",
            href: "/timetable/teacher-availability",
            icon: "UserCheck",
            permission: PERMISSIONS.TEACHER_AVAILABILITY_READ,
          },
          {
            title: "Versions",
            href: "/timetable/versions",
            icon: "History",
            permission: PERMISSIONS.TIMETABLE_VERSION_READ,
          },
        ],
      },
    ],
